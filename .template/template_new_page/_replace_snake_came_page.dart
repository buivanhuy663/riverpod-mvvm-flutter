...
final _provider = StateNotifierProvider.autoDispose<ReplacePascalCameViewModel, ReplacePascalCameState>(
...
class ReplacePascalCamePage extends BasePage {
  ...
  @override
  BasePageState<ReplacePascalCamePage, ReplacePascalCameViewModel> createState() => _ReplacePascalCamePageState();
}

class _ReplacePascalCamePageState extends BasePageState<ReplacePascalCamePage, ReplacePascalCameViewModel> {
  @override
